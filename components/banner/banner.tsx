  ...
  return (
    <div className='flex h-screen justify-between bg-[#1a1a1a]'>
      <div className="flex flex-col flex-1">
            <div className="flex flex-1 justify-center items-end text-7xl text-white">
                  <p className='flex justify-end font-medium p-7 pl-32 h-1/4 w-3/4 flex-col'><span className='flex text-[#c32865]'>Howdy,</span>I am Prabhat</p>
            </div>
